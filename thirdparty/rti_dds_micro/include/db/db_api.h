...
RTI_INT32
(*DB_IndexCompare_T)(RTI_INT32 flags,const DB_Record_T op1, void *key)
)
 ...
 *
 * \return A record destructor function must return RTI_TRUE on success and
 *         RTI_FALSE on failure. NOTE: Even if the dtor returns failure the
