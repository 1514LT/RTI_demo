...
#else
#ifdef TSeq_isCDRStringType_no_max
TSeq_from_array(struct TSeq *self, const T elv[], RTI_INT32 length,RTI_INT32 max_str_length)
#else
...
TSeq_from_array_w_max(struct TSeq *self, const T elv[], RTI_INT32 length,RTI_INT32 max_str_length)
#endif
#endif
{
#ifdef RTI_CPP
...
#else
#ifdef TSeq_isCDRStringType_no_max
TSeq_to_array(struct TSeq *self,T elv[], RTI_INT32 length,RTI_INT32 max_str_length)
#else
...
TSeq_to_array_w_max(struct TSeq *self,T elv[], RTI_INT32 length,RTI_INT32 max_str_length)
#endif
#endif
{
#ifdef RTI_CPP
